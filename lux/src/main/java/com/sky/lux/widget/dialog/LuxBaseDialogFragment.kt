...
import com.sky.lux.utils.bottomMargin
import com.sky.lux.utils.endMargin
import com.sky.lux.utils.startMargin
...
abstract class LuxBaseDialogFragment : AppCompatDialogFragment() {
    ...
    companion object {
        ...
        @JvmField
        val WINDOW_ANIM_BOTTOM_IN_BOTTOM_OUT = R.style.Lux_DialogBottomStyle

        @JvmField
        val WINDOW_ANIM_LEFT_IN_LEFT_OUT = R.style.Lux_DialogLeftStyle

        @JvmField
        val WINDOW_ANIM_CENTER_SCALE = R.style.Lux_DialogCenterScale

        @JvmField
        val WINDOW_ANIM_RIGHT_IN_RIGHT_OUT = R.style.Lux_DialogRightStyle

        @JvmField
        val WINDOW_ANIM_TOP_IN_TOP_OUT = R.style.Lux_DialogTopStyle

        private const val SAVED_MARGIN_ARRAY = "luxBaseDialogFragment:marginArray"

        private const val SAVED_MAX_HEIGHT = "luxBaseDialogFragment:maxHeight"
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setStyle(STYLE_NORMAL, R.style.Lux_Theme_Base_Dialog)
        showsDialog = true
        initData()
        initViewModel()
    }
