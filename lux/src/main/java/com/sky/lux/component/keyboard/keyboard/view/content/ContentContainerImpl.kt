package com.sky.lux.component.keyboard.keyboard.view.content
    ...
    init {
        ...
        mInputAction = object : IInputAction {
            ...
            inner class ResetSelectionRunnable : Runnable {
                override fun run() {
                    if (mainFocusIndex != -1 && mainFocusIndex <= mainInputView?.text?.length ?: 0) {
                ...
                mainInputView?.accessibilityDelegate = object : View.AccessibilityDelegate() {
                    override fun sendAccessibilityEvent(host: View?, eventType: Int) {
                        ...
                        if (eventType == AccessibilityEvent.TYPE_VIEW_TEXT_SELECTION_CHANGED) {
                            if (realEditViewAttach && mainInputView?.hasFocus() == true && !checkoutInputRight) {
                                mainFocusIndex = mainInputView.selectionStart
                            }
                        }
                    }
