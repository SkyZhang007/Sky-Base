package com.sky.lux.component.keyboard.keyboard.view
...
import com.sky.lux.component.keyboard.keyboard.device.DeviceInfo
import com.sky.lux.component.keyboard.keyboard.device.DeviceRuntime
import com.sky.lux.component.keyboard.keyboard.device.LogFormatter
...
import com.sky.lux.component.keyboard.keyboard.interfaces.listener.OnEditFocusChangeListener
import com.sky.lux.component.keyboard.keyboard.interfaces.listener.OnKeyboardStateListener
import com.sky.lux.component.keyboard.keyboard.interfaces.listener.OnPanelChangeListener
import com.sky.lux.component.keyboard.keyboard.interfaces.listener.OnViewClickListener
import com.sky.lux.component.keyboard.keyboard.device.PanelUtil
import com.sky.lux.component.keyboard.keyboard.device.PanelUtil.getLocationOnScreen
import com.sky.lux.component.keyboard.keyboard.device.PanelUtil.getKeyBoardHeight
import com.sky.lux.component.keyboard.keyboard.device.PanelUtil.getScreenHeightWithoutSystemUI
import com.sky.lux.component.keyboard.keyboard.device.PanelUtil.getScreenRealHeight
import com.sky.lux.component.keyboard.keyboard.device.PanelUtil.isPortrait
import com.sky.lux.component.keyboard.keyboard.view.content.IContentContainer
import com.sky.lux.component.keyboard.keyboard.view.panel.IPanelView
import com.sky.lux.component.keyboard.keyboard.view.panel.PanelContainer
...
//                        LogTracker.log("$TAG#initListener", "panelItem invalid click! preClickTime: $preClickTime currentClickTime: $currentTime")
    ...
    private fun getAndroidQNavHIfNavIsInvisible(runtime: DeviceRuntime, window: Window): Int {
        return if (!runtime.isNavigationBarShow && Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q && PanelUtil.hasSystemUIFlag(window, View.SYSTEM_UI_FLAG_LAYOUT_HIDE_NAVIGATION)) {
